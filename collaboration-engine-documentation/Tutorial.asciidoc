...
Collaboration Engine is provided by Vaadin upon request. https://vaadin.com/collaboration[Contact Vaadin] to get access to the package and instructions on how to install it.
...
For the sake of this tutorial, let's generate the user's id based on the UI instance
and use the generated id in the user's name as well.
